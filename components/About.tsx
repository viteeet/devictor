...
import { Code2, Users, Award, Building2, Linkedin } from 'lucide-react';
    ...
    <section id="about" className="py-14 bg-darker">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-[minmax(0,320px)_1fr] gap-8 md:gap-12 items-start mb-12"
        >
          ...
          {STAT_KEYS.map((key, index) => {
            ...
            return (
              <motion.div
                ...
                className="text-center p-6 rounded-xl border border-slate-700 bg-slate-800 hover:bg-slate-700 hover:border-slate-600 shadow-sm transition-colors"
              >
                ...
                <div className="text-slate-300 text-sm">{t(`about.stats.${key}`)}</div>
              </motion.div>
            );
          })}
        </div>
